...
SELECT e.department_id, e.first_name, e.last_name, e.job_id, d.department_name FROM employees e JOIN departments d 
...
SELECT e.first_name, e.last_name, d.department_id, d.department_nam FROM departments d
...
SELECT e.first_name, e.last_name, e.salary, e.department_id, e.job_id FROM employees e
JOIN employees e2 ON e.job_id = e2.job_id
WHERE e2.employee_id = 169;
...
SELECT CONCAT(e.first_name, ' ', e.last_name) AS full_name, d.department_name FROM employees e
...
SELECT employee_id, start_date, end_date, job_id, department_id FROM employees
WHERE salary >= 12000;
...
SELECT e.first_name, e.last_name, e.employee_id, d.department_name FROM employees e
JOIN departments d ON e.employee_id = d.manager_id;
